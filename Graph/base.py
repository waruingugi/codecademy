# Graph Data Structure contains a vertex and graph
# Vertex: 
# - uses a dictionary to store connected vertices.
...
# Graph:
# - can be initiliazed as a directed or undirected graph
# - stores every vertex inside a dictionary
# - has methods to add vertices, edges between vertices, and determine if a path exists
